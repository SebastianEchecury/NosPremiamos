...
namespace EOH.Admin.Domain.Emailing
{
    public class EmailTemplateProvider : IEmailTemplateProvider
    {
        ...
        {
            using (var stream = typeof(EmailTemplateProvider).GetTypeInfo().Assembly.GetManifestResourceStream("EOH.Admin.Domain.Emailing.EmailTemplates.default.html"))
            { 
