...
export class LayoutConfig implements ConfigModel {
	public config: any = {
		...
		self: {
			...
			background: './assets/app/media/img/bg/login.png' // boxed layout background
		},
		...
		header: {
			...
			self: {
				...
				logo: {
					dark: './assets/demo/default/media/img/logo/logo.png',
					light: './assets/demo/default/media/img/logo/logo.png'
				}
			},
